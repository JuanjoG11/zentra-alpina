...
async function run() {
  ...
  console.log('Rechazos Total (Otros Motivos):', rechazosSum.toFixed(2));
  console.log('Cambios Total (Vencimiento / M.E.):', cambiosSum.toFixed(2));
  console.log('Total Devolución:', (rechazosSum + cambiosSum).toFixed(2));
  console.log('Ratio Rechazos:', (rechazosSum / (rechazosSum + cambiosSum) * 100).toFixed(2) + '%');
  console.log('Ratio Cambios:', (cambiosSum / (rechazosSum + cambiosSum) * 100).toFixed(2) + '%');
}
